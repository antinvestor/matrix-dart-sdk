...
class Api {
  ...
  Future<int> pingAppservice(
    ...
    request.bodyBytes = utf8.encode(
      jsonEncode({if (transactionId != null) 'transaction_id': transactionId}),
    );
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
    if (response.statusCode != 200) unexpectedResponse(response, responseBody);
    ...
    return ((v) =>
        v != null
            ? (v as List)
                .map(
                  (v) =>
                      ThirdPartyIdentifier.fromJson(v as Map<String, Object?>),
                )
                .toList()
            : null)(json['threepids']);
  }
  ...
  Future<Uri?> post3PIDs(ThreePidCredentials threePidCreds) async {
    ...
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(
      jsonEncode({'three_pid_creds': threePidCreds.toJson()}),
    );
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
    if (response.statusCode != 200) unexpectedResponse(response, responseBody);
    final responseString = utf8.decode(responseBody);
    final json = jsonDecode(responseString);
    return ((v) => v != null ? Uri.parse(v as String) : null)(
      json['submit_url'],
    );
  }
  ...
  Future<IdServerUnbindResult> delete3pidFromAccount(
    ...
    final responseString = utf8.decode(responseBody);
    final json = jsonDecode(responseString);
    return IdServerUnbindResult.values.fromString(
      json['id_server_unbind_result'] as String,
    )!;
  }
  ...
  Future<Visibility?> getRoomVisibilityOnDirectory(String roomId) async {
    ...
    final json = jsonDecode(responseString);
    return ((v) =>
        v != null ? Visibility.values.fromString(v as String)! : null)(
      json['visibility'],
    );
  }
  ...
  Future<void> setRoomVisibilityOnDirectory(
    ...
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(
      jsonEncode({if (visibility != null) 'visibility': visibility.name}),
    );
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
    if (response.statusCode != 200) unexpectedResponse(response, responseBody);
    ...
    request.bodyBytes = utf8.encode(
      jsonEncode({
        'device_keys': deviceKeys.map(
          (k, v) => MapEntry(k, v.map((v) => v).toList()),
        ),
        if (timeout != null) 'timeout': timeout,
      }),
    );
  ...
  Future<Map<String, int>> uploadKeys({
    ...
    final responseString = utf8.decode(responseBody);
    final json = jsonDecode(responseString);
    return (json['one_time_key_counts'] as Map<String, Object?>).map(
  ...
  Future<void> setAvatarUrl(String userId, Uri? avatarUrl) async {
    ...
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(
      jsonEncode({if (avatarUrl != null) 'avatar_url': avatarUrl.toString()}),
    );
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
    if (response.statusCode != 200) unexpectedResponse(response, responseBody);
  ...
  Future<void> setDisplayName(String userId, String? displayname) async {
    ...
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(
      jsonEncode({if (displayname != null) 'displayname': displayname}),
    );
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
    if (response.statusCode != 200) unexpectedResponse(response, responseBody);
  ...
  Future<void> setPushRuleActions(
    ...
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(
      jsonEncode({'actions': actions.map((v) => v).toList()}),
    );
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
    if (response.statusCode != 200) unexpectedResponse(response, responseBody);
  ...
  Future<String> postRoomKeysVersion(
    ...
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(
      jsonEncode({'algorithm': algorithm.name, 'auth_data': authData}),
    );
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
    if (response.statusCode != 200) unexpectedResponse(response, responseBody);
  ...
  Future<void> ban(String roomId, String userId, {String? reason}) async {
    ...
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(
      jsonEncode({if (reason != null) 'reason': reason, 'user_id': userId}),
    );
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
    if (response.statusCode != 200) unexpectedResponse(response, responseBody);
  ...
  Future<void> postReceipt(
    ...
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(
      jsonEncode({if (threadId != null) 'thread_id': threadId}),
    );
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
    if (response.statusCode != 200) unexpectedResponse(response, responseBody);
  ...
  Future<void> setTyping(
    ...
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(
      jsonEncode({if (timeout != null) 'timeout': timeout, 'typing': typing}),
    );
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
    if (response.statusCode != 200) unexpectedResponse(response, responseBody);
  ...
  Future<String> upgradeRoom(String roomId, String newVersion) async {
    ...
    request.headers['authorization'] = 'Bearer ${bearerToken!}';
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(jsonEncode({'new_version': newVersion}));
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
    if (response.statusCode != 200) unexpectedResponse(response, responseBody);
    final responseString = utf8.decode(responseBody);
  ...
  Future<SearchResults> search(
    ...
    request.headers['content-type'] = 'application/json';
    request.bodyBytes = utf8.encode(
      jsonEncode({'search_categories': searchCategories.toJson()}),
    );
    final response = await httpClient.send(request);
    final responseBody = await response.stream.toBytes();
    if (response.statusCode != 200) unexpectedResponse(response, responseBody);
  ...
  Future<Map<String, Tag>?> getRoomTags(String userId, String roomId) async {
    ...
    return ((v) =>
        v != null
            ? (v as Map<String, Object?>).map(
              (k, v) => MapEntry(k, Tag.fromJson(v as Map<String, Object?>)),
            )
            : null)(json['tags']);
  }
