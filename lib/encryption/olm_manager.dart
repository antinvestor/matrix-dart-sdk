    ...
    try {
      ...
      if (oldKeyCount != null) {
        ...
        final oldOTKsNeedingUpload =
            json.decode(olmAccount.one_time_keys())['curve25519'].entries.length
                as int;
      ...
      if (uploadDeviceKeys) {
        final Map<String, dynamic> keys = json.decode(
      ...
      final currentUpload =
          this.currentUpload = CancelableOperation.fromFuture(
            client.uploadKeys(
              deviceKeys:
                  uploadDeviceKeys
