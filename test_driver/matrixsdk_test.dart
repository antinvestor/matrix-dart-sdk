...
void main() => group('Integration tests', () {
    ...
    try {
      ...
      expect(
        testClientA
            .encryption!
            .olmManager
            .olmSessions[testClientB.identityKey]!
            .length,
        olmLengthMatcher,
      );
      expect(
        testClientB
            .encryption!
            .olmManager
            .olmSessions[testClientA.identityKey]!
            .length,
        olmLengthMatcher,
      );
      expect(
      ...
      final inviteRoomOutboundGroupSession =
          inviteRoom.client.encryption!.keyManager.getOutboundGroupSession(
            inviteRoom.id,
          )!;
  ...
  expect(room.client.encryption.keyManager.getInboundGroupSession(
      ...
      expect(
        testClientA
            .encryption!
            .olmManager
            .olmSessions[testClientC.identityKey]!
            .length,
        olmLengthMatcher,
      );
      expect(
      ...
      Logs().i('++++ Logout Bob another client ${testClientC.deviceID} ++++');
  ...
  test('dm creation', () async {
    ...
    try {
      ...
      final dmRoomFromB = await testClientB.startDirectChat(
        testClientA.userID!,
      );
      ...
      expect(
        dmRoom,
        dmRoomFromB,
        reason: "Bob should join alice's DM room instead of creating a new one",
      );
      expect(
...
Object get olmLengthMatcher {
  ...
  Platform.environment['HOMESERVER_IMPLEMENTATION'] != 'dendrite'
      ? 1
      : predicate([1, 2].contains, 'is either 1 or two');
}
